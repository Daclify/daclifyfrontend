          ...
          <q-card-section>
            ...
            <q-tabs v-model="active_tab" class="text-primary" dense align="left">
              <q-tab
                ...
                class="text-grey"
                name="text"
                @mouseover="edit_tab_show = true"
                @mouseout="edit_tab_show = false"
              >
                <div>
              ...
              <q-tab :label="`Profile`" name="textview">
                <q-icon
                  name="mdi-pencil"
                  v-if="
                    isProfileChanged && isProfileChanged.find((ipc) => ipc.path == 'text')
                  "
                />
              </q-tab>
  ...
  computed: {
    ...
    isProfileChanged() {
      if (
        ...
        this.profile_data &&
        this.profile_data.account == this.getMyOldProfile.account
      ) {
  ...
  methods: {
    async updateProfileDataKey() {
      ...
      if (res && res.trxid) {
        ...
        this.$store.commit("group/updateProfileTimestamp", {
          account: this.getAccountName,
          timestamp: res.block_time,
        });
        this.$store.commit(
