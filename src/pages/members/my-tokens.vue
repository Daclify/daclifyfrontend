  ...
  <q-page padding class="constrain-page-width">
      ...
      <div class="row justify-between q-mb-md q-py-sm">
        <q-item>
          ...
          <q-item-section>
            ...
            <q-item-label caption>{{
              getCoreConfig.conf.withdrawals ? "enabled" : "disabled"
            }}</q-item-label>
          </q-item-section>
        </q-item>
        ...
        <q-item>
          ...
          <q-item-section>
            ...
            <q-item-label caption>{{
              getCoreConfig.conf.deposits ? "enabled" : "disabled"
            }}</q-item-label>
          </q-item-section>
        </q-item>
        ...
        <q-item>
          <q-item-section avatar>
            <q-icon
              v-if="getCoreConfig.conf.internal_transfers"
              name="check"
              color="positive"
            />
            <q-icon v-else name="close" color="negative" />
          ...
          <q-item-section>
            <q-item-label class="text-h6 text-weight-light"
              >Internal Transfers</q-item-label
            >
            <q-item-label caption>{{
              getCoreConfig.conf.internal_transfers ? "enabled" : "disabled"
            }}</q-item-label>
          </q-item-section>
        </q-item>
      </div>
    ...
    <q-card v-if="!myTokens.length">
      <q-card-section class="text-weight-light"
        >You don't own tokens in this group</q-card-section
      >
    </q-card>
    <transition-group
      appear
