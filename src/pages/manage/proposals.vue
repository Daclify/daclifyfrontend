<template>
  <q-page padding class="text-black overflow-hidden constrain-page-width">
    ...
    <transition
      ...
      tag="div"
    >
      <span class="row items-center text-grey-7" v-if="!getProposalsWithFilter.length">
    ...
    >
      <proposal-card
        v-for="proposal in getProposalsWithFilter"
        :proposal="proposal"
        :key="tabfilter + proposal.id"
        :proposalstate="tabfilter"
      />
    </transition-group>
