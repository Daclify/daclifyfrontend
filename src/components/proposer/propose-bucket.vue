      ...
      >
        <template v-slot:header>
          <q-item-section avatar>
            <div class="relative-position" style="height: 70px; width: 70px">
              ...
              <number-pop-animation
                :input_value="getActionBucket.length"
                class="absolute"
                style="top: 35px; left: 21px"
              />
            </div>
          ...
          <q-item-section>
            ...
            <q-item-label caption class="gt-xs text-grey-6"
              >The bucket holds multiple actions to propose at once.</q-item-label
            >
          </q-item-section>
              ...
              >
                <q-list dense style="min-width: 100px" class="primary-hover-list">
                  <q-item clickable v-close-popup @click="bucket_opened = !bucket_opened">
                    <q-item-section>{{
                      bucket_opened ? "Close" : "Open"
                    }}</q-item-section>
                  </q-item>
                  <q-item
                    :disabled="!getActionBucket.length"
                    clickable
                    v-close-popup
                    @click="handleViewRawClick"
                  >
                  ...
                  <q-item
                    ...
                    clickable
                    v-close-popup
                    @click="$store.commit('bucket/setActionBucket', [])"
                  >
        ...
        >
          <q-tab-panel name="bucket_list" class="overflow-hidden no-padding">
            <div>
              ...
              >
                <div
                  v-if="getActionBucket.length"
                  class="row items-center justify-between q-pa-md bg-secondary"
                >
            ...
            <div class="q-col-gutter-md">
              ...
              <div>
                <div
                  ...
                  @click="preview_description = !preview_description"
                >
          ...
          <q-tab-panel name="view_raw_bucket" class="overflow-hidden text-secondary">
            ...
            >
              <div v-html="getRawBucketContent"></div>
            </q-scroll-area>
          </q-tab-panel>
        </q-tab-panels>
      </q-expansion-item>
