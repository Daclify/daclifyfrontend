            ...
            <div class="row q-col-gutter-xs">
              <q-item class="col-xs-12">
                ...
                <q-item-section>
                  <q-item-label class="text-weight-light">Last Active</q-item-label>
                  <q-item-label caption>
                    <span v-if="!guardian.last_active.startsWith('1970')"
                      ><date-string :date="guardian.last_active"
                    /></span>
                    <span v-else>Not been Active Yet</span>
                  </q-item-label>
                </q-item-section>
              ...
              <q-item class="col-xs-12">
                ...
                <q-item-section>
                  <q-item-label class="text-weight-light">Guardian Since</q-item-label>
                  <q-item-label caption
                    ><date-string :date="guardian.joined"
                  /></q-item-label>
                </q-item-section>
              </q-item>
            ...
            >
              <div v-if="!profile_is_loading" class="q-px-md q-pb-md q-pt-xs">
                ...
                <q-btn
                  ...
                  class="full-width"
                  label="full profile"
                  :to="`/members/${getActiveGroup}/profile/${guardian.account}`"
                />
              </div>
              <div
                v-else
