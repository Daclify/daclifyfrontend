<template>
  <div>
    <div class="relative-position" style="width: 30px; height: 30px">
      <div
        class="display_value row justify-center items-center bg-primary round text-caption text-white fit"
      >
        <div>{{ display }}</div>
      </div>
      ...
      >
        <div
          v-if="play_add_animation"
          class="fit row justify-center items-center bg-positive text-white round"
        >
          {{ delta }}
        </div>
      </transition>
      ...
      >
        <div
          v-if="play_remove_animation"
          class="fit row justify-center items-center bg-negative text-white round"
        >
          {{ delta }}
        </div>
      </transition>
