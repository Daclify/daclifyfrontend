    ...
    <q-card>
      <q-card-section>
        <div class="row items-center">
          <q-item class="">
            <q-item-section>
              ...
              <q-item-label caption
                ><date-string :date="getIsCandidate.registered"
              /></q-item-label>
            </q-item-section>
          </q-item>
          ...
          <q-item class="">
            <q-item-section>
              ...
              <q-item-label caption v-if="getUserCandidateStake">{{
                getUserCandidateStake.quantity
              }}</q-item-label>
            </q-item-section>
          </q-item>
          ...
          <q-item
            v-if="getElectionsConfig && !!parseFloat(getElectionsConfig.max_pay.quantity)"
          >
            <q-item-section>
        ...
        <div class="row justify-end q-mt-md q-pb-xs">
          ...
          <q-btn
            :label="getIsCandidate.state == 1 ? 'pause campaign' : 'resume campaign'"
            color="primary"
            @click="pauseCampaign"
            :loading="is_pausing"
            class="q-ml-md"
